...
public class GripPipeline implements VisionPipeline {
    ...
    @Override	public void process(Mat source0) {
        ...
        double[] hsvThresholdHue = {67.98561151079137, 143.63636363636365};
        double[] hsvThresholdSaturation = {129.3345323741007, 255.0};
        double[] hsvThresholdValue = {75.67446043165467, 255.0};
